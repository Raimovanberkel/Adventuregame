...
function meldn(){
var tekstmelden = ["Klik om te starten","Naar volgende kamer","Naar 3","Naar 4","Naar 5","Naar 6", "Naar 7", "Naar 8", "Oeps gaat niet verder" ];
var  loc=level
return tekstmelden[loc];
}

function meldp(){
var tekstmelden = ["Oeps hier kan je niet terug","Naar begin","Naar 1","Naar 2","Naar 3","Naar 4","Naar 5","Naar 6","Terug Naar 7" ];
var  loc=level
return tekstmelden[loc];
}
...
function uilmov(){
document.getElementById("uiltje").style.display="block";
}
